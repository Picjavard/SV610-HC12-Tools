...
//Colors
private color c_very_dark = color(19,66,103); //#134267
private color c_dark = color(28,99,155);//#1C639B
private color c_mid = color(37,131,206);//#2583CE
private color c_light= color(46,159,255);//#2E9FFF

private color c_primary= color(46,159,255);//#2E9FFF
private color c_hover = color(100,184,255);//#64B8FF
